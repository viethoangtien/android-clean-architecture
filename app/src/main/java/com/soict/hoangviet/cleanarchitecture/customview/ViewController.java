...
public class ViewController<T extends BaseFragment> {
    ...
    public void replaceFragment(Class<T> type, HashMap<String, Object> data) {
        replaceFragment(type, data, true, false);
    }

    public void replaceFragment(Class<T> type, HashMap<String, Object> data, boolean isLogOut) {
        replaceFragment(type, data, true, isLogOut);
    }


    public void replaceFragment(Class<T> type, HashMap<String, Object> data, boolean hasAnimation, boolean isLogOut) {
        /*
        ...
        if (hasAnimation) {
            if (isLogOut) {
                ...
                fragmentTransaction.setCustomAnimations(R.anim.trans_right_in, R.anim.trans_left_out);
            }
        }
        fragmentTransaction.replace(layoutId, currentFragment);
